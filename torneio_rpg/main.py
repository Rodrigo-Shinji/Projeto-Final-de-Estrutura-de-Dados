...
def main():
    ...
    # Carrega personagens e times previamente salvos em arquivos
    carregar_personagens()
    carregar_times()

    while True:
        opcao = menu_principal()  # Mostra o menu principal
        if opcao == '1':  # Vai para o menu de personagens
            gerenciar_personagens()
        elif opcao == '2':  # Vai para o menu de times
            gerenciar_times()
        elif opcao == '3':  # Inicia uma batalha entre dois times
            iniciar_batalha()
        elif opcao == '0':  # Encerra o sistema
